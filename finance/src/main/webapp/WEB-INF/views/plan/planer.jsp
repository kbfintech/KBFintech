...
<body>
   ...
   <div>
      <form action="planOK.jsp" method="get">
         <table width="80%" align="center">
            <tr>
               <td colspan="4" align="center"><h1 class="title">
                     <fmt:formatDate value="${date}" type="DATE" pattern="MM" />
                     월 카드 한도 설정
                  </h1></td>
            </tr>
            <tr>
               ...
               <td width="25%" align="center"><h5 class="category-name">화장품</h5></td>
               <td width="25%" align="center"><h5 class="category-name">쇼핑</h5></td>
            </tr>
            <tr align="center">
               ...
               <td width="25%" align="center"><input type="text"
                  ...
                  onkeyup="total();" /></td>
               <td width="25%" align="center"><input type="text"
                  name="cosmetics" size="100%" class="plan-form" placeholder="0"
                  onkeyup="total();" /></td>
               <td width="25%" align="center"><input type="text"
                  name="shopping" size="100%" class="plan-form" placeholder="0"
                  onkeyup="total();" /></td>
            </tr>
            <tr>
